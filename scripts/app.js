    ...
    const projectsData = [
      {
        ...
        name: "Todo List",
        description:
          "A simple and elegant todo list application with local storage support.",
      ...
      },
      {
        ...
        name: "Digital Clock",
        description:
          "A beautiful digital clock with customizable themes and formats.",
      ...
      },
      {
        ...
        description:
          "Convert text into ASCII art with various font styles and customization options.",
      ...
      },
      {
        ...
        description:
          "Visualize password strength and complexity with interactive graphics.",
      ...
      },
      {
        ...
        description:
          "Interactive physics simulation with bouncing balls and gravity effects.",
      ...
      },
      {
        ...
        description:
          "Generate inspirational quotes with beautiful backgrounds and sharing options.",
      ...
      },
      {
        ...
        description:
          "Count characters, words, and paragraphs in real-time with detailed statistics.",
      ...
      },
      {
        ...
        description:
          "Simulate dice rolls with realistic 3D animations and multiple dice options.",
      ...
      },
      {
        ...
        description:
          "A fun number guessing game with hints and score tracking.",
      ...
      },
      {
        ...
        description:
          "A modern twist on the classic brick breaker game with neon graphics.",
      ...
      },
      {
        ...
        name: "Weather App",
        description:
          "Get real-time weather information for any city with a beautiful interface.",
      ...
      },
      {
        ...
        name: "Coin Flip",
        description:
          "A realistic coin flipping animation with statistics tracking.",
      ...
      },
      {
        ...
        description:
          "Educational platform for e-waste management with location finder.",
      ...
      },
      {
        ...
        description:
          "Generate random user profiles with photos and detailed information.",
      ...
      },
      {
        ...
        description:
          "Search and browse high-quality images with advanced filtering options.",
      ...
      },
      {
        ...
        name: "Tic Tac Toe",
        description:
          "Classic tic-tac-toe game with AI opponent and score tracking.",
      ...
      },
      {
        ...
        name: "Candy Crush",
        description:
          "Match-3 puzzle game inspired by the popular Candy Crush saga.",
      ...
      },
      {
        ...
        name: "Drawing App",
        description:
          "Digital drawing canvas with multiple brush tools and colors.",
      ...
      },
      {
        ...
        description:
          "Test your reflexes by clicking on moving targets as fast as possible.",
      ...
      },
      {
        ...
        name: "Memory Game",
        description:
          "Classic memory card matching game with multiple difficulty levels.",
      ...
      },
      {
        ...
        name: "Color Picker",
        description:
          "Advanced color picker with multiple format outputs and palette saving.",
      ...
      },
      {
        ...
        description:
          "Professional drawing application with layers and advanced tools.",
      ...
      },
      {
        ...
        name: "Notes App",
        description:
          "Feature-rich notes application with search and organization tools.",
      ...
      },
      {
        ...
        name: "Note Taker",
        description:
          "Simple and efficient note-taking app with markdown support.",
      ...
      },
      {
        ...
        description:
          "Interactive audio visualizer with particle effects and real-time frequency analysis.",
      ...
      },
      {
        ...
        name: "Pomodoro Timer",
        description:
          "Productivity timer with task management, customizable themes, and session tracking.",
      ...
      },
      {
        ...
        name: "Chess Game",
        description:
          "Interactive chess game with move validation, piece animations, and game state tracking.",
      ...
      },
      {
        ...
        name: "Rock Paper Scissors",
        description:
          "Interactive rock paper scissors game with user vs computer gameplay.",
...

      {
        ...
        description:
          "Modern portfolio website template with responsive design and animations.",
      ...
      },
      {
        ...
        name: "Etch-a-Sketch",
        description:
          "Digital Etch-a-Sketch with customizable grid and drawing modes.",
      ...
      },
      {
        ...
        name: "GiggleBits",
        description:
          "Fun collection of interactive mini-games and entertainment.",
      ...
      },
      {
        ...
        description:
          "Create beautiful CSS gradients with live preview and export functionality.",
      ...
      },
      {
        ...
        description:
          "Classic board game with multiplayer support and animated gameplay.",
      ...
      },
      {
        ...
        description:
          "Exciting space-themed jumping game with physics engine and score system.",
      ...
      },
      {
        ...
        name: "Stopwatch",
        description:
          "Precision stopwatch with lap timing and split functionality.",
      ...
      },
      {
        ...
        name: "World Clock",
        description:
          "Display multiple world time zones with real-time updates and customization.",
      ...
      },
      {
        ...
        name: "Notes Tracker",
        description:
          "A simple and organized digital notebook to create, update, and manage notes efficiently.",
        demoLink: "./public/Day-42_NoteTaker/index.html",
      ...
      },
      {
        ...
        name: "Alien Hunt",
        description:
          "A fun and fast-paced shooting game where players hunt down aliens and score points.",
        demoLink: "./public/Day-31/index.html",
        category: "games",
        technologies: ["HTML", "CSS", "JavaScript"],
        features: [
      ...
      },
      {
        ...
        description:
          "Suggests books based on user-selected genres, moods, or interests with a clean UI.",
      ...
      },
      {
        ...
        description:
          "Analyzes student marks and provides insights like total, average, grade, and performance level.",
      ...
      },
      {
        ...
        description:
          "Recommends music tracks based on the user's selected mood for a personalized listening experience.",
      ...
      },
      {
        ...
        name: "CalRace",
        description:
          "A fast-paced calculator racing game where players solve math problems under time pressure to advance.",
        demoLink: "./public/Day-45/index.html",
        category: "games",
        technologies: ["HTML", "CSS", "JavaScript"],
        features: [
      ...
      },
      {
        ...
        description:
          "An interactive word guessing game where players try to reveal the hidden word within limited attempts.",
      ...
      },
      {
        ...
        name: "4 in a Row",
        description:
          "A strategic two-player game where the goal is to connect four discs in a row vertically, horizontally, or diagonally.",
      ...
      },
      {
        ...
        name: "Budget Tracker",
        description:
          "A simple financial tracking tool to manage income, expenses, and visualize spending habits.",
      ...
      },
      {
        ...
        description:
          "A classic card-flipping memory game where players match pairs to win with the fewest moves.",
      ...
      },
      {
        ...
        name: "MyPaint",
        description:
          "A simple and fun digital drawing app that allows users to sketch, doodle, and paint freely on a canvas.",
...

      {
        ...
        description:
          "Manage university operations including courses, students, and faculty.",
      ...
      },
      {
        ...
        name: "Hangman",
        description:
          "A fully responsive, animated Hangman game with SVG drawing, confetti, and playful UI.",
        demoLink: "./public/Hangman/index.html",
        category: "games",
        technologies: ["HTML", "CSS", "JavaScript", "SVG"],
        features: [
          "Animated Drawing",
      ...
      },
      {
        ...
        description:
          "Advanced, vibrant web app to track daily steps and water intake with charts, themes, and responsive design.",
