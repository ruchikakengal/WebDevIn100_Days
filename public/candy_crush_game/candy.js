...
window.onload = function () {
    ...
    // Run game loop every 1/10th of a second
...
function startGame() {
    board = []; // Reset board on reload
    document.getElementById("board").innerHTML = ""; // Clear old tiles if reloaded
