...
function fillTable() {
    const data = [
        ...
        ["Day 5", "Password Strength Visualizer (by Adwitya)", " /public/password_visualizer/index.html"],
        ["Day 6", "Physics Simulation (by Vishisht Dwivedi)", " /public/physics_simulation/index.html"],
        ["Day 7", "Quote Generator (by Sania Rajput)", " /public/QuoteGenerator/index.html"],
        ["Day 8", "Character Word Counter (by Anchal Chaturvedi)", " /public/CharacterWordCounter/index.html"],
        ["Day 9", "Dice Roll Simulator"," /public/DICEROLLSIMULATOR/index.html"],
        ["Day 10", "Guess My Number (by Pahima R Uchil)", "./public/Guess_My_Number/index.html"],
        ["Day 11", "Character Word Counter (by Anchal Chaturvedi)", " /public/CharacterWordCounter/index.html"],
        ["Day 12", "Dice Roll Simulator"," /public/DICEROLLSIMULATOR/index.html"],
        ["Day 13", "Guess My Number (by Pahima R Uchil)", "./public/Guess_My_Number/index.html"],
        ["Day 14", "Neon Brick Breaker (by Sejal Kamble) ", "./public/Neon_Brick_Breaker/index.html" ],
        ["Day 15", "Countdown Banner (by Priyanshi)", "https://countdown-banner.vercel.app/",], 
        ["Day 16", "Countdown Banner (by Priyanshi)", "https://countdown-banner.vercel.app/",], 
        ["Day 17", "Coin Flip Heads/Tails (by Radhika Dodain) ","./public/Coin_Flip/index.html"],
        ["Day 18", "E- waste Management Hub(by Abhirup Nandi)","https://e-waste-management-hub.netlify.app/"],
        ...
        ["Day 22", "WaterMedic (By Dee) ","https://github.com/dipmanmajumdar/WaterMedic"],
        ["Day 23", "URL Shortner","https://github.com/ANTIK-007/URL-Shortener"],
        ["Day 24","Interactive Portfolio (by Priya Katariya)","/public/portfolio/index.html"],
        ["Day 25", "Candy Crush","public/candycrush/candy_crush.html"],
        ["Day 100", "Coming Soon...", "#"]
